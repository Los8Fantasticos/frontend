        ...
        <div className="h-full bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4">
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    <p tabIndex={0} role="heading" aria-label="Iniciar sesión" className="text-2xl font-extrabold leading-6 text-gray-800">
                        Iniciar sesión
                    </p>
                    ...
                    <button aria-label="Continuar con Github" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                        ...
                        <p className="text-base font-medium ml-4 text-gray-700">Continuar con Github</p>
                    </button>
                    <button aria-label="Continuar con Twitter" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                        ...
                        <p className="text-base font-medium ml-4 text-gray-700">Continuar con Twitter</p>
                    </button>
